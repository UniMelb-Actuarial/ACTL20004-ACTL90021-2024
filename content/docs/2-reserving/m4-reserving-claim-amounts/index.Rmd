...
output_name <- "24-Top-M4-lec" # change latest slides below, too!
...
[^1]: References: Chapter 3 of @Tay00 | $\; \rightarrow$  [\textcolor{blue}{\underline{latest slides}}](https://gim-am3.netlify.app/output/24-Top-M4-lec.pdf) 
...
- See the spreadsheet [`PPCI.xlsx`](https://canvas.lms.unimelb.edu.au/courses/220261/modules/items/6021477) for details of the calculations, which are based on the data of @Tay00, but do not follow the (more complicated) calculations of Chapter 4.
