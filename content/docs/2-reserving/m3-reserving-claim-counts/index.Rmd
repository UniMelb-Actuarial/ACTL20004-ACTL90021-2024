...
output_name <- "24-Top-M3-lec" # change latest slides below, too!
...
[^1]: References: Chapter 2 of @Tay00 | $\; \rightarrow$ [\textcolor{blue}{\underline{latest slides}}](https://gim-am3.netlify.app/output/24-Top-M3-lec.pdf) 
...
Nevertheless @Tay00 argues that the difference is small and  
...
- Quoting @Tay00: "The name is understood to refer to the chaining of a sequence of ratios (the age to age factors below) into a ladder of factors (the age to ultimate factors below) which enable one to climb (i.e. project) from experience recorded to date to its predicted ultimate value."
...
- It can be shown (see @Tay00) that the estimators seen  
