...
output_name <- "24-Top-M6-lec" # change latest slides below, too!
...
[^1]: References: @EE19 and @AE23 | $\; \rightarrow$ [\textcolor{blue}{\underline{latest slides}}](https://topics-actl.netlify.app/output/24-Top-M6-lec.pdf) 
[^2]: Contributions from Ho Ming Lee and William Ho are gratefully acknowledged.
...
- Converting table into "machine-readable" formats.
  - An example in Chapter 1, P.2-9 in @MyDS23.
...
Reference: Chapter 7 and 11 of @AEF22
...
knitr::include_graphics("offset_example.png") 
```
...
```{r, fig.align='center', out.width="100%", echo=F}
knitr::include_graphics("indirect_example.png") 
```
...
```{r, fig.align='center', out.width="100%", echo=F}
knitr::include_graphics("indad.png") 
```
...
1. A dialog box will be opened. You can rename your macro and select a shortcut key for the macro.
1. Click "OK" to create your macro. Excel will now start recording your actions.
1. Click "Stop Recording" to save your macro.
...
- Running macros through the Developer tab.
    ...
    1. Click on the sheet and cells you want to run a macro with. Click "Run" to run it.
- Running macros with buttons.
    1. Go to Developer → Form Controls → Insert → Button.
    1. Click on the cell you want to insert the button, the Assign Macro box should come up.
    1. Choose your macro and click "OK". Now you can run your macro by clicking the button.
- There are more ways to run macros. See P.886-894 in @EE19.
...
Reference: Chapter 2, 3 of @EoE23
